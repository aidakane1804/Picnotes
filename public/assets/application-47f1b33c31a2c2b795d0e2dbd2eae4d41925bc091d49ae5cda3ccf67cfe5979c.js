...
CKEDITOR.editorConfig = function( config ) {
  ...
  config.extraPlugins = 'font, richcombo, listblock';
    ...
    if ($('#infinite-scrolling').length > 0) {
        return $(window).on('scroll', function () {
            ...
            if (more_posts_url && $(window).scrollTop() > $(document).height() - $(window).height() - 500) {
                $('.pagination').html('<img style="margin-left: auto;margin-right: auto" src="/assets/ajax-loader-b9c65237ee36e6f434ed5fbcfe95f7100b50e12ab448b887fbcca368bb6137e1.gif" alt="Loading..." title="Loading..." />');
                setTimeout(function () {
